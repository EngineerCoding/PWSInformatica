...
public class JSONObject extends JSON {
	 ...
	 *
	 * @param key The key of the associated value
	 * @return A {@link com.ameling.parser.json.JSON.Type} object, defining the object which is associated with the key
	 * @throws JSONException when the key is not in the {@link #storage}
	 */
	...
	/**
	 * Retrieves a value from the key and tries to convert it to a {@link com.ameling.parser.json.JSONObject}
	 *
	 * @param key String defining a key which is in the {@link #storage}
	 * @return The {@link com.ameling.parser.json.JSONObject} associated with the key
	 * @throws JSONException when the key is not in the {@link #storage}
	 */
	...
	/**
	 * Retrieves a value from the key and tries to convert it to a {@link com.ameling.parser.json.JSONArray}
	 *
	 * @param key String defining a key which is in the {@link #storage}
	 * @return The {@link com.ameling.parser.json.JSONArray} associated with the key
	 * @throws JSONException when the key is not in the {@link #storage}
	 */
	...
	/**
	 * Sets the given key to the given {@link com.ameling.parser.json.JSONObject}
	 *
	 * @param key   The key to set the value to
	 * @param value The value to set the key to
	 * @return Whether it succeed or not to set the value. It will fail when the key or value is null.
	...
	/**
	 * Sets the given key to the given {@link com.ameling.parser.json.JSONArray}
	 *
	 * @param key   The key to set the value to
	 * @param value The value to set the key to
	 * @return Whether it succeed or not to set the value. It will fail when the key or value is null.
	...
	/**
	 * Sets the given object to {@link com.ameling.parser.json.JSON#NULL}
	 *
	 * @param key The key to set {@link com.ameling.parser.json.JSON#NULL} to
