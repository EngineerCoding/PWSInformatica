...
/**
 * The main super class of both {@link JSONObject} and {@link com.ameling.parser.json.JSON}. As an user this class is useless to you since this handles all
...
public abstract class JSON extends Parser {
	...
	/**
	 * An enumeration which contains types of all the values, used by {@link com.ameling.parser.json.JSON#getType(Object)}
	 *
	 * @author Wesley A
	 */
	public static enum Type {
		...
		/**
		 * An object of {@link com.ameling.parser.json.JSON.Null}
		 */
		DummyNull,
	...
	private static class Null {
		/**
		 * Only reachable in {@link com.ameling.parser.json.JSON} where the only Null object is stored
		 */
		private Null () {
		}
	 ...
	 *
	 * @see {@link com.ameling.parser.json.JSON.Null}
	 */
	...
	/**
	 * Gets the {@link com.ameling.parser.json.JSON.Type} of the object
	 *
	 * @param object The object to check
	 * @return Type the type of this object, when it is not recognised or null, it will return {@link com.ameling.parser.json.JSON.Type#Null}
	 */
